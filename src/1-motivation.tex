...
\begin{itemize}
  \item support \review{programmers in} rapid prototyping numerical algorithms and code generation, also in different target languages;
  \item when dealing with \review{implementation of} mathematical models \review{in numerical algorithms}, support a clean and separate formulation of conditioning rules for numerical \review{instabilities}, in order to support \review{generation of code that is more robust with respect to issue that can be introduced by specific applications};
